...
- Selected target shows its 4-hour trajectory across the sky map, so you can see at a glance which way it's drifting and whether it's about to leave your window.
